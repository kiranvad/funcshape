...
def get_warping_function(f1 : Function, f2 : Function, **kwargs)->Tuple[Function, CurveReparametrizer , np.ndarray]:
    ...
    Optional:
        ...
        n_restarts -- number of optimization restarts (default, 50)
        ...
        n_iters -- number of optimization iterations (default, 100)
        eps -- threshold for early stopping of optimization (default, 1e-2)
